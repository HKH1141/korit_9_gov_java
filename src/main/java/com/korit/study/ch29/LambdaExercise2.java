...
public class LambdaExercise2 {
    public static void main(String[] args) {
        ...
        MathOperation max = (n1, n2) -> n1 > n2 ? n1 : n2;
        ...
        TripleOperation average = (n1, n2, n3) -> (n1 + n2 + n3) / 3;


        // TODO 5: 이름, 나이, 도시를 받아서 형식화된 문자열로 만드는 람다
        // 출력 형식: "이름: 홍길동, 나이: 25세, 거주지: 서울"
        Formatter personInfo = (name, age, address) -> String.format("이름: %s, 나이: %d세, 거주지: %s", name, age, address);
        // 여기에 람다 작성
